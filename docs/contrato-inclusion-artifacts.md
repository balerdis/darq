...
3. Los seis plugins locales aprobados (`src/darq/adapters/opencode/assets/plugins/`). Cuatro se instalan con el prefijo del binario — `pegasus` en esta distribución — y dos conservan su nombre de origen:
