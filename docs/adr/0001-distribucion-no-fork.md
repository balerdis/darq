...
Estado: **superada** por `docs/adr/0005-fork-no-distribucion.md` (2026-09-22). Se conserva sin
reescribir porque documenta con exactitud el modelo vigente hasta esa fecha; leerla como
descripción del presente es un error — ver la ADR que la sucede.
