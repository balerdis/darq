#!/usr/bin/env python3
"""Build the portable DARQ skill index with only Python's standard library."""
...
def render(project_root: Path, roots: list[Path], skills: list[Skill]) -> str:
    lines = [
        ...
        "",
        "<!-- Generated by DARQ skill registry. Regenerate with darq-skill-registry. -->",
        "",
        "## Sources scanned",
        "",
    ]
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate a DARQ skill registry")
