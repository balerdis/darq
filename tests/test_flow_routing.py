...
FLOW_APPLICABILITY = ROOT / "src" / "darq" / "content" / "skills" / "_shared" / "flow-applicability.md"
CORPUS = ROOT / "tests" / "fixtures" / "routing-corpus" / "cases.json"
EXPLORER = ROOT / "src" / "darq" / "content" / "agents" / "darq-explorer.md"
...
class ExplorerReturnsRoutingFactsTest(unittest.TestCase):
    ...
    When a brief asks for routing facts, `darq-explorer` returns exactly the
