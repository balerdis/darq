...
from darq.core.types import Artifact, ConfigKeyArtifact, FileArtifact, Layout, ModelAssignment
...
def command(layout: Layout, item: Command, orchestrator_name: str) -> list[Artifact]:
    ...
    `darq.core.content.SESSION_STARTS_IN`), and it names the `agent:` field
