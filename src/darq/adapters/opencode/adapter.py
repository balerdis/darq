...
from darq.adapters.opencode import layout as layout_module
from darq.adapters.opencode import manifest as manifest_module
from darq.adapters.opencode import models as models_module
from darq.adapters.opencode import naming
from darq.adapters.opencode import render
from darq.core import placeholders
from darq.core.content import Agent, Command, Mcp, Skill, SystemPrompt
from darq.core.identity import Identity
from darq.core.model_catalog import ModelCatalog
...
#: `darq.core.content`, which hit the identical constraint first.
AssetNode = Any
...
def _asset_files(directory: AssetNode) -> list[tuple[AssetNode, PurePosixPath]]:
    ...
    `darq.core.content` already had to write for the identical reason. A
