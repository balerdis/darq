...
from darq.core import frontmatter, placeholders
...
DEFAULT_ROOT: ContentRoot = _package_files("darq") / "content"
MARKER = "---"
SKILL_FILE = "SKILL.md"
...
SESSION_STARTS_IN = (_package_files("darq") / "content" / "session-start.txt").read_text(
    encoding="utf-8"
).strip()
