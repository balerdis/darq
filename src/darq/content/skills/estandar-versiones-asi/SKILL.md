...
- Read `estandar-versiones-asi/references/version-matrix.md` before changing dependencies, runtime/build/test/tool configuration, framework scaffolding, or commands.
...
- `estandar-versiones-asi/references/version-matrix.md` - authoritative extracted ASI v6.4 matrix and document/page provenance.
- `estandar-versiones-asi/references/provenance.md` - package-local provenance and distribution boundary.
