"""``python -m darq``: the same entry point the launcher will call.
...
#: The floor `tarfile.data_filter` (PEP 706, used by `darq.core.dependencies`) needs. Kept in
...
from darq.cli import main  # noqa: E402
